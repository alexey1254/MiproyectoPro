...
public class EditorialDAO {
    ...
    public static Editorial getEditorial(String codigo) throws Exception {
        ...
        if (!ps.execute()) {
            throw new Exception("getProducto: Error accediendo a la tabla Editoriales. Código de producto: "+codigo);
        }
